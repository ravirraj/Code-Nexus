...
function CopilotView() {
    ...
    return (
        ...
        >
            <h1 className="view-title mb-2">Copilot</h1>
            {/* Input and Controls Area */}
            <div className="flex flex-col gap-2">
                <textarea
                    className="min-h-[100px] w-full rounded-md border-none bg-darkHover p-2 text-white outline-none"
                ...
                {output && (
                    <div className="flex justify-end gap-4 border-t border-slate-700 pt-2">
            ...
            {/* Output Area */}
            <div className="mt-2 flex-grow overflow-y-auto rounded-lg border-t border-slate-700 pt-2 pr-2">
                <ReactMarkdown
                    components={{
                        ...
                        pre({ children }) {
                            return <pre className="!m-0 !bg-transparent">{children}</pre>
                        },
                    }}
                >
                    {output}
