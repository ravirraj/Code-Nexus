...
const ChatsView = () => {
    ...
    return (
        <div
            className="flex flex-col gap-2 p-2 chat-container relative h-full min-w-[320px] overflow-hidden"
            data-active="CHATS"
            style={{ 
                height: '100%',
        ...
        >
            ...
            <div 
                className="chat-input-container bg-slate-900 p-3 border-t border-slate-700 w-full absolute bottom-0 left-0 right-0 z-10"
